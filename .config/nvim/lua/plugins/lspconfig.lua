		...
		config = function()
			vim.api.nvim_create_autocmd('LspAttach', {
				callback = function(event)
					...
					vim.keymap.set('n', '<leader>fd', require('telescope.builtin').lsp_type_definitions,
			...
			require('mason-lspconfig').setup {
				ensure_installed = vim.tbl_keys(vim.g.lang.lspconfig or {}),
				handlers = {
					function(server_name)
						local server = vim.g.lang.lspconfig[server_name] or {}
